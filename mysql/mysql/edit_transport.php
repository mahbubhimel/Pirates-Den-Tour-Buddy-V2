...
<form action="update_transport.php?transport_id=<?php echo $id ?>" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="district_id" required="required" aria-describedby="emailHelp" placeholder="Address" value="<?php echo $transport_info['district_id']; ?>">
  </div>
