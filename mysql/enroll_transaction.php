...
<form action="enroll_going.php?client_id=<?php echo $id ?>&group_id=<?php echo $group_id ?>" method="POST">

  <!-- <div class="form-group">
    <label for="transaction_amount">Amount</label>
    <input type="text" class="form-control" name="transaction_amount" required="required" placeholder="Enter Amount">
  </div> -->

  <div class="form-group">
    <label for="transaction_num">Transaction Number</label>
    <input type="text" class="form-control" name="transaction_num" required="required" placeholder="Enter Your Transaction Number">
  </div>
