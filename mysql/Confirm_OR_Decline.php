...
$conn = new mysqli('localhost','root','','travel');
 $sql = "SELECT c.client_id as id,c.client_name as name,e.status as status
FROM enroll as e JOIN
client as c ON e.client_id = c.client_id
WHERE group_id = $id";
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a class="btn btn-info" href="client_host_view.php?group_id=<?php echo $id;?>&client_id=<?php echo $row['id'] ?>">View</a>
                </td>
              </tr>
            <?php } ?>
            </tbody>
