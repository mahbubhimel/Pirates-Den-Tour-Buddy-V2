    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <td>
            <a class="btn btn-warning" href="Confirm_OR_Decline.php?group_id= <?php echo $id =$_GET['group_id'];?>&client_id=<?php echo $id=$_GET['client_id']; ?>"><h5>Client List</h5></a>
          </td>
          <td>
            <a class="btn btn-success" href="messaging3.php?group_id= <?php echo $id =$_GET['group_id'];?>&client_id=<?php echo $id=$_GET['client_id']; ?>"><h5>Messaging</h5></a>
          </td>
